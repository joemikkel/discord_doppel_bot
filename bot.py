...
class Bot(object):
	...
	def run(self):
		...
		async def on_message(message):
			...
			if message.content == f"<@!{self.discord_id}>":
	...
	async def make_reply(self, message):
		...
		print(self.format_message_history(messages))
		print("Making a reply")
		return f"Thanks for mentioning me! This is a reply generated by the robot_{self.username} bot"
